class Car{
    ...
    motorOn(dir){
        ...
        if (dir == 1)
        {
            this.wh1.joint.SetMotorSpeed(- dir * PI*13)
            this.wh1.joint.SetMaxMotorTorque(1200)
            this.wh2.joint.SetMotorSpeed(- dir * PI*13)
            this.wh2.joint.SetMaxMotorTorque(1000)
    ...
    applyTorque(dir){
        this.frame.body.ApplyTorque(-dir*2)
    }
}